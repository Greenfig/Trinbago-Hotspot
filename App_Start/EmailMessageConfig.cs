    ...
    public static class MessageConfig
    {
        private static string Message(string body)
        {
            return "<html><head><meta name='viewport'content='width=device-width,initial-scale=1.0'></head><body><div class='navbar navbar-default'>" +
                ...
                "<fieldset><div class='row'><div class='col-md-12'style='margin-bottom:20px;'>" +
                body +
                "<div class='footer'><div class='container'><div class='row'><div class='col-sm-4 col-12'><p><strong>&copy;2018&nbsp;-&nbsp;trinbagohotspot.com</strong></p>" +
                "<p>All rights reserved</p></div><div class='col-sm-8 col-12' style='display:table-cell;'><p class='footer-links'><a href='https://trinbagohotspot.com'>Home</a>" +
        ...
        private static string ForgotPasswordMessageBody
        {
            get
            {
        ...
        private static string ClassifiedAdMessageExpireBody
        {
            get
            {
                return "<div class='col-sm-12'><div class='well'><fieldset><h2 class='formhead'>Ad Expiration</h2><div class='col-md-12'style='background-color:white'>" +
                    "<span>Hello {0},<br/><a href='{1}' target='_blank'>Your ad</a> will be expiring on {2}. You can extend the date by going to the following link: <section>" +
                    "<a href='{3}'>Extend expiration date</a></section><br/>If clicking the link does not work, copy & paste this url into your browser: <section>{3}</section><br/>" +
                    "<br/>The ad will be removed by the given date if you do not extend it.<br/><p>Thank you,</p><br/><p>TrinbagoHotspot.com </p></span></div></fieldset></div></div>" +
                    "</div></fieldset></div></div><br></div></div></div>";
            }
        }
        ...
        public static string ReplyToAdMessage(ClassifiedAdEmailUserPost msg)
        {
            return Message(string.Format(ReplyToAdMessageBody, msg.Name, msg.From, msg.Message, msg.ItemUrl, msg.AdTitle));
        }
        ...
        public static string ContactUsMessage(string body)
        {
            return Message(body);
        }

        public static string ClassifiedAdExpireMessage(HangfireMessage msg)
        {
            return Message(string.Format(ClassifiedAdMessageExpireBody, msg.UserName, msg.AdUrl, msg.DateTime, msg.ExtendUrl));
        }
    }
}